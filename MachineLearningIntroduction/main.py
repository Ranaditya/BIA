...
def main() -> None:
    ...
    print("\nGenerated plots (saved to images/):")
    print("  - images/eda_histograms.png")
    print("  - images/eda_scatter_plots.png")
    print("  - images/eda_correlation_heatmap.png")
    print("  - images/eda_boxplots.png")
    print("  - images/model_predictions.png")
    print("  - images/model_residuals.png")
